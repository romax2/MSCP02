...
public class CleanPerformanceAppender2 {
	private static Logger logger = Logger.getLogger(CleanPerformanceAppender2.class);
			...
			for (int i = 0; i < lmaArtistList.getLength(); i++){
				...
				if(!lmaArtist.getAttribute("appender").equals("true")){
					...
					try {
						...
						List<LMAPerformance> performances = dbman.getLmaPerformancesByLmaArtistURI2(lmaArtistUri);
